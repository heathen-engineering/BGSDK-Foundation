...
{
    public abstract class TokeProperties : ScriptableObject
    {
    ...
    /// </para>
    /// <para>
    /// Note that it is not nessisary to provide any body to the resulting custom property type ... this will be handled for you via the <see cref="TokenProperties{T}"/> base class.
    /// </para>
    /// </remarks>
    /// <example>
    /// <code>
    ...
    /// </code>
    /// </example>
    public class TokenProperties<T> : TokeProperties
    {
